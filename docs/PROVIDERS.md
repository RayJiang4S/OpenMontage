...
| **Doubao Speech** | `DOUBAO_SPEECH_API_KEY` | `doubao_tts` | Paid usage |
| **MiniMax Speech** | `MINIMAX_API_KEY` | `minimax_tts` | Paid usage |
...
| **Text-to-Speech** | Azure AI Speech, Doubao Speech, MiniMax Speech, ElevenLabs, Google TTS, OpenAI Speech API, OpenAI Audio TTS | Piper | Piper, Google free tier, ElevenLabs free tier |
